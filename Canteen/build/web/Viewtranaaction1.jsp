		...
		<div class="w3l_banner_nav_right">
            ...
            <center>
                    ...
                    <h1 align="center" style="color: #449d44; font-family: cursive;
                        font-size: 30px;
                        font-weight: bold;">View all Transaction Details</h1><br>
                    ...
                    <table> <tr><th>Flower</th>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from orders where sid='"+id+"' and sname='"+name+"' and status='Delivery'");
			...
			<!-- //flexSlider -->
                        ...
                        <div class="clearfix"></div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	</div>
<!-- banner -->
