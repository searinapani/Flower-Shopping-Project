								...
								<figure> 
									<div class="snipcart-item block" style="height: 350px; padding-bottom: 10px;">
										...
										<div class="snipcart-details">
                                                                                    ...
                                                                                    <a href="order.jsp?fimage=<%=image%>&&fname=<%=rs.getString("fname")%>&&fdes=<%=rs.getString("fdes")%>&&cost=<%=rs.getString("cost")%>&&ready=<%=rs.getString("ready")%>"><button style="color:white;   background: red; border-radius: 15px; height: 40px; width:170px;">Add to Cart</button></a>
