		...
		<div class="w3l_banner_nav_right">
			<section class="slider">
             ...
             <style>
                ...
                table{
                    border-radius: 30px;
                       ...
                       <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from register where sno='"+id+"' and sname='"+name+"' ");
                ...
                <center>                          
                        <h2 style="color: brown; margin-left:-72px; font-weight: bold;"><img src="profile/<%=image%>" alt="logo" style="height: 70px; width: 70px; border-radius: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Our Profile</h2><br>
                        <table align="center">
