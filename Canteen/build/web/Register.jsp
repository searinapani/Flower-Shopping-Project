...
<!-- login -->
		<div class="w3_login" style="margin-right : 200px;">
			<h3 style="color: red; font-family:cursive;">Sign In & Sign Up</h3>
				...
				<div class="module form-module">
				  <div class="toggle"><i class="fa fa-times fa-pencil"></i>
					...
					<form action="Register_Action" method="post" enctype="multipart/form-data">
					  <strong style="font-weight: 5px;">Profile</strong><input type="file" name="image" placeholder="Profile" required=" "><br>
					  
					  <input type="text" name="sno" placeholder="User ID" required=" ">
