...
public class Food_Action extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	            ...
	            while (itr.hasNext()) {
	                ...
	                else
	                {
	                  ...
	                  System.out.println("trying to put all in store");
	                   savedFile = new File(sc.getRealPath("food")+"\\"+finalimage);
	                try 
	                    {
		...
		try 
		{
            ...
            PreparedStatement query=con.prepareStatement("insert into flower(fno,fimage,fname,fdes,cost,ready)values ('"+m.get(0)+"','"+ms.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"')");
                    System.out.println(query);
                    query.executeUpdate();
                    System.out.println(query);
                    out.println("<script>"); 			
                    out.println("alert(\"Flower Add Succesfully\")");
                    out.println("</script>");
