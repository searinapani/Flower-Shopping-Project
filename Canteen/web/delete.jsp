...
String fno=request.getParameter("fno");
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/flower","root","root");
                    ...
                    PreparedStatement query=con.prepareStatement("delete from flower where fimage='"+fimage+"' and fname='"+fname+"' and fno='"+fno+"'");
                    System.out.println(query);
                    query.executeUpdate();
                    System.out.println(query);
                    out.println("<script>"); 			
                    out.println("alert(\"Flower Deleted Succesfully\")");
                    out.println("</script>");
