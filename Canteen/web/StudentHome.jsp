			...
			<div class="wthree_banner_bottom_left_grid_sub1">
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="images/pani.jpg" alt=" " style="width:250px;" class="img-responsive" />
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="images/sa.jpg" alt=" " style="width:250px;" class="img-responsive" />
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="images/set coffee.jpg"  style="width:250px;" alt=" " class="img-responsive" />
