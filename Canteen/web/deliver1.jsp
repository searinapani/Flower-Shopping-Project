...
String email=request.getParameter("email");
    ...
    mail m=new mail();
    String subject="your Flower Order Reject, Sorry Try Again";
    ...
    m.sendFromGMail("1cp.javateam2020", "1cpjava2020",email, subject,mall);
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/flower","root","root");                
                    PreparedStatement query=con.prepareStatement("update orders set status='Reject' where sname='"+sname+"' and id='"+id+"' and fname='"+fname+"' and sid='"+sid+"'");
                    System.out.println(query);
                    query.executeUpdate();
                    System.out.println(query);
                    out.println("<script>"); 			
                    out.println("alert(\"Sorry Your Oder Reject Try Again\")");
                    out.println("</script>");
