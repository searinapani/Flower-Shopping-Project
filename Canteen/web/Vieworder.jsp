		...
		<div class="w3l_banner_nav_right">
		 <style>
                    ...
                    table{
                        ...
                        <h3 align="center" style="font-weight:bold; color: brown; font-size: 30px;">View all New Order Status</h3>
                    <table> <tr><th>Flower</th>
                            <th>ID</th>
                            <th>Name</th>                            
                            <th>Flower Name</th>
                            <th>Cost</th>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from orders where status='Waiting'");
                        ...
                        while(rs.next())
                        {
                            ...
                            int c=rs.getInt("cost"); 
                             ...
                             int e=c*q;
                        %>
                        <tr><td><img src="food/<%=image%>" alt="" style="width: 90px; height: 90px; border-radius: 50px;"></td>
                            ...
                            <td><a href="delivery.jsp?id=<%=rs.getString("id")%>&&cost=<%=rs.getString("cost")%>&&sid=<%=rs.getString("sid")%>&&email=<%=rs.getString("email")%>&&sname=<%=rs.getString("sname")%>&&fname=<%=rs.getString("fname")%>" style="color:red;width:100px;">Accept</a>&nbsp;/&nbsp;<a href="deliver1.jsp?id=<%=rs.getString("id")%>&&cost=id=<%=rs.getString("cost")%>&&sid=<%=rs.getString("sid")%>&&email=<%=rs.getString("email")%>&&sname=<%=rs.getString("sname")%>&&fname=<%=rs.getString("fname")%>" style="color:red;width:100px;">Reject</a></td><%}%></tr>
                    </table>
                    <br><br><br><br></div>
