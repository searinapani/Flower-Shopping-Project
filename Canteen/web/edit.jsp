...
%>
                        ...
                        <table align="center">
                        <h2 align="center" style="color: orangered;  font-weight: bold; font-size: 30px;"><img src="food/<%=fimage%>" alt="logo" style="height: 100px; width: 100px; border-radius: 30px;">&nbsp;&nbsp;Edit Your Flower </h2><br>
                        <tr align="center"><td>Flower NO </td><td><input type="text" name="fno" value="<%=fno%>" readonly=""></td></tr>
                        <tr align="center"><td>Flower Name </td><td><input type="text" name="fname" value="<%=fname%>" readonly=""></td></tr>
                        <tr align="center"><td>Flower Description</td><td><input type="text" name="fdes" value="<%=fdes%>" style="heigth:200px;" requried=""></td></tr>
                        <tr align="center"><td>Cost </td><td><input type="text" value="<%=cost%>" name="cost" requried=""></td></tr>
                        <tr align="center"><td>Status</td><td><select name="status" requried="" style="width:300px;">
                                    <option>Enable</option>
                                    <option>Disable</option>
                                </select></td></tr>
                        <tr align="center"><td>Ready to Prepare</td><td><input type="text" value="<%=ready%>" name="ready" requried=""></td></tr>
